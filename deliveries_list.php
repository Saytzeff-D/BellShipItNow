...
<head>
  ...
  <!-- Title-->
  <title><?php echo $lang['langs_01071'] ?> | <?php echo $core->site_name;?></title>
  ...
  <div class="container">
    <div class="row">
    	<div class="col-12 text-center text-white">
    		<h1 class="text-white"><?php echo $lang['langs_01072'] ?></h1>
				...
				<div class="tab-pane fade active show rounded" id="day1" role="tabpanel" aria-expanded="true">
					<table class="table table-responsive text-center text-md-left">
						<thead class="bg-secondary border-0 text-white">
							<tr>
								<th scope="col" class="text-center text-md-left"><?php echo $lang['langs_01073'] ?></th>
								<th scope="col" class="text-center text-md-left"><?php echo $lang['langs_01074'] ?></th>
								<th scope="col" class="text-center text-md-left"><?php echo $lang['langs_01075'] ?></th>
								<th scope="col" class="text-center text-md-left"><?php echo $lang['langs_01076'] ?></th>
								<th scope="col" class="text-center text-md-left"><?php echo $lang['langs_01077'] ?></th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<?php echo "
								<i align='center' class='display-3 text-warning d-block'><img src='dashboard/assets/images/alert/ohh_shipment.png' width='143' alt='the us brand you love' /></i>					
								",false;?>
							...
							<?php foreach ($deliverpackagerow  as $row):?>							
								<td><a  href="edit_deliver.php?do=edit_deliver&amp;action=ship&amp;id=<?php echo $row->id;?>" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['booking-list11'] ?>"><?php echo $row->order_inv;?></a></td>
								...
								<td>
									<a  href="edit_deliver.php?do=edit_deliver&amp;action=ship&amp;id=<?php echo $row->id;?>" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['booking-list11'] ?>"><i style="color:#343a40" class="ti-truck"></i> <?php echo $lang['langs_01078'] ?></a>
								</td>
							</tr>
							<?php endforeach;?>
							<?php unset($row);?>
